...
function displayItems(filteredMenu) {
  let section = document.querySelector('.section-center');
  section.innerHTML = '';
  filteredMenu.forEach((item, index) => {
    const cardItem = `<!-- single item -->
  <article class="menu-item ${index}">
    <img src="${item.img}" alt="menu item ${index}" class="photo">
    <div class="item-info">
      <header>
...
function displayButtons(filterBtns){
  filterBtns.forEach(function (btn) {
    btn.addEventListener('click', function (e) {
      ...
      const filteredMenu = menu.filter(menuItems => category == menuItems.category)
